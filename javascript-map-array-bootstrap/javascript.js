...
const title1 = array.map(index => `${index.title}`);

let element1 = title[0];

var element1 = Document.getElementById("cardTitle1");
var bodyElement = document.body;
bodyElement.innerHTML = element1 + bodyElement.innerHTML;
